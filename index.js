...
const subohanAllahIncrement = document.getElementById(
  "subohan-allah-increment"
);
const subohanAllahDecrement = document.getElementById(
  "subohan-allah-decrement"
);

const alhamdulillahDisplay = document.getElementById("alhamdulillah-display");
const alhamdulillahIncrement = document.getElementById(
  "alhamdulillah-increment"
);
const alhamdullillahDecrement = document.getElementById(
  "alhamdullillah-decrement"
);
